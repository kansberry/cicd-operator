...
import (
	...
	"github.com/kansberry/cicd-operator/api/v1alpha1"
	"github.com/kansberry/cicd-operator/helpers"
...
// +kubebuilder:rbac:groups=cicd.cicd.com,resources=cibuilds/finalizers,verbs=update
// +kubebuilder:rbac:groups=apps,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core,resources=pods,verbs=get;list;
// +kubebuilder:rbac:groups=batch,resources=jobs,verbs=get;list;watch;create;update;patch;delete

//Reconcile reconciles loop
func (r *CDeployReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
